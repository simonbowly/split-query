...
from octo_spork.query import Column, GE, GT, LE, LT, In, And, Or, Between, Not
...
@pytest.mark.parametrize('obj, expected', [
    ...
    (GE(col1, 1), "table1.column1 >= 1"),
    (GT(col1, 1), "table1.column1 > 1"),
    (LE(col1, 1), "table1.column1 <= 1"),
    (LT(col1, 1), "table1.column1 < 1"),
